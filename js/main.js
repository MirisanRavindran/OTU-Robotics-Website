...
const testimonials = [
    ...
    },
    {
      ...
      image: "https://static-exp1.licdn.com/sc/h/244xhbkr7g40x6bsu4gi6q4ry",
      testimonial:
        "This is my second year in Ontario Tech Robotics, and I have experienced an enriching journey that has significantly contributed to my professional development. The program has equipped me with a diverse skill set, ranging from rapidly acquiring proficiency in robot programming using WPILIB in just three days to delving into the complexities of embedded systems through projects like RoboMaster.Throughout my tenure, Ontario Tech Robotics has not only enhanced my technical capabilities but also honed my communication skills, enabling me to articulate complex concepts with clarity. One notable aspect of my growth has been the mastery of effective team coordination, exemplified by my ability to lead and synchronize a team seamlessly on collaborative GitHub projects.I have acquired a comprehensive understanding of software development practices, including adept usage of branching strategies, adherence to coding standards, and the importance of clear code documentation. From mastering version control to refining coding styles, naming conventions, and implementing thorough comments, my experience at Ontario Tech Robotics has instilled in me a commitment to professional excellence in software engineering.As I reflect on this transformative journey, I am confident that the invaluable skills and knowledge gained will serve as a solid foundation for my future endeavors. Ontario Tech Robotics has not only prepared me technically but has also cultivated a professional ethos that will undoubtedly contribute to my success in the ever-evolving field of robotics and beyond."
    },
    {
